...
DECLARE
    ...
    V_NUM NUMBER; -- 변수 선언
    V_NAME VARCHAR(10) := '홍길동'; -- 변수선언과 초기화를 같이
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE(V_NAME || '님의 나이는 ' || V_NUM || '입니다.'); -- 출력구문
...
DECLARE 
    ...
    NAME VARCHAR2(30);
    SALARY NUMBER;
    LAST_NAME EMPLOYEES.LAST_NAME%TYPE; -- EMP테이블의 LAST_NAME컬럼과 동일한 타입으로 선언한다
