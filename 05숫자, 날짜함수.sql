...
-- MOD
SELECT 5 /3, MOD(5, 3) FROM DUAL; //몫, 나머지값 구하기
...
-- 날짜는 연산이 가능함
SELECT HIRE_DATE, HIRE_DATE + 1, HIRE_DATE -1 FROM EMPLOYEES; -- 일자 기준으로 연산이 됨

SELECT FIRST_NAME, SYSDATE - HIRE_DATE FROM EMPLOYEES; -- 입사날부터 오늘까지 일수
...
SELECT ROUND(SYSDATE, 'YEAR'), TRUNC(SYSDATE, 'YEAR') FROM DUAL; -- 년 기준으로 반올림, 절삭
